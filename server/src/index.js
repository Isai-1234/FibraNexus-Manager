...
import { wisphubRouter } from './routes/wisphub.js';
...
app.use('/api/orgs/:orgId/dte', authenticateToken, requireActiveOrg, dteRouter);
app.use('/api/orgs/:orgId/wisphub', authenticateToken, requireActiveOrg, wisphubRouter);
